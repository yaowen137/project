   ...
   <div class="login-main"> 
    ...
    <div class="login-box"> 
     ...
     <div class="login-form1"> 
      <form action="/ulogin" method="post" id="myform"> 
      {{csrf_field()}}
       <div class="user-name"> 
        <label for="user"><i class="am-icon-user"></i></label> 
        <input type="text" name="action" id="user" placeholder="手机/用户名" /> 
       </div> 
       <div class="user-pass"> 
       ...
       <div class="user-pass"> 
        <label for="captcha"><i class="am-icon-th"></i></label> 
     ...
     <div class="am-cf"> 
      <input type="submit" name="" value="登 录" class="am-btn am-btn-primary am-btn-sm" form="myform"/> 
     </div> 
     <div class="partner"> 
      <h3>合作账号</h3> 
